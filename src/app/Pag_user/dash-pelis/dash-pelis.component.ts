...
@Component({
  selector: 'app-dash-pelis',
  standalone: true,
  imports: [DashHeaderComponent, PelisfComponent, FooterComponent],
  templateUrl: './dash-pelis.component.html',
  styleUrl: './dash-pelis.component.css'
})
export class DashPelisComponent {
